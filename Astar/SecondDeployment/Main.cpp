...
#include <Astar/SecondDeployment/Top/SecondDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    Astar::setupTopology(inputs);
    Astar::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    Astar::teardownTopology(inputs);
