...
// Included for access to FirstDeployment::TopologyState and FirstDeployment::ConfigObjects::pingEntries. These
// definitions are required by the autocoder, but are also used in this hand-coded topology.
#include <Astar/FirstDeployment/Top/FirstDeploymentTopologyDefs.hpp>
