...
#include "Astar/FirstDeployment/Top/FppConstantsAc.hpp"
 ...
 */
namespace PingEntries {
namespace Astar_rateGroup1 {
enum { WARN = 3, FATAL = 5 };
}
namespace Astar_rateGroup2 {
enum { WARN = 3, FATAL = 5 };
}
namespace Astar_rateGroup3 {
enum { WARN = 3, FATAL = 5 };
}
namespace Astar_cmdSeq {
enum { WARN = 3, FATAL = 5 };
}
}  // namespace PingEntries
